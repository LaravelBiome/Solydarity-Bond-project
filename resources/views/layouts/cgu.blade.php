...
<div id="C1Q1"><h3>Communication des données personnelles à des tiers</h3><p>
<b>
...
<div id="C6Q1"><h3>Collecte des données d'identité</h3><p>
<b>
...
<div id="C7Q1"><h3>Collecte des données d'identification</h3><p>
<b>
...
<div id="C8Q1"><h3>Géolocalisation</h3><p>
<b>
...
</p><ul><li>Vous notifier l'incident dans les plus brefs délais ;</li>
<li>Examiner les causes de l'incident et vous en informer ; </li>
<li>Prendre les mesures nécessaires dans la limite du raisonnable afin d'amoindrir les effets négatifs et préjudices pouvant résulter dudit incident</li></ul>
<p></p>
...
<br>
L'Éditeur s'engage à respecter la réglementation applicable relative aux transferts des données vers des pays étrangers et notamment selon les modalités suivantes :<br>
</p><ul><li>L'Éditeur transfère les données personnelles de ses Utilisateurs vers des pays reconnus comme offrant un niveau de protection équivalent.</li>
<li>L'Éditeur transfère les données personnelles de ses Utilisateurs en dehors des pays reconnus par la CNIL comme ayant un niveau de protection suffisant : L'Éditeur a obtenu une autorisation de la CNIL pour procéder à ce transfert.</li></ul>
Pour connaître la liste de ces pays :
<a href="https://www.cnil.fr/fr/la-protection-des-donnees-dans-le-monde" target="_blank">CNIL - La protection des données dans le monde</a>
...
<div id="C17Q1"><h3>Droit applicable et modalités de recours</h3><p>
<b>
...
<div id="C18Q1"><h3>Portabilité des données</h3><p>
<b>
...
<div class="space-up">
<a rel="license" class="inline-block license" target="_blank" href="http://creativecommons.org/licenses/by-sa/4.0/">
<img alt="Licence Creative Commons" style="border-width:0" src="https://i.creativecommons.org/l/by-sa/4.0/88x31.png"></a>
<i class="inline-block license-text">Ces CGU sont mises à disposition par<a target="_blank" href="http://www.aboutinnovation.com"> Aboutinnovation</a> et<a href="http://privacytech.fr" target="_blank"> Privacy Tech</a> selon les termes de la <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/" target="_blank"> Licence Creative Commons Attribution -  Partage dans les Mêmes Conditions 4.0 International</a>.</i></div>
